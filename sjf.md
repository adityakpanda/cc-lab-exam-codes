...
public class sjf {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Create multiple Cloudlets with different lengths
Connection connection = DriverManager.getConnection(JDBC_URL, DB_USER, DB_PASSWORD);

            // Read Cloudlet data from the database
            List<Cloudlet> cloudletList = retrieveCloudletProperties(connection);

            // Sort Cloudlets based on submission times (FCFS)
            // Sort Cloudlets based on submission times (FCFS)
